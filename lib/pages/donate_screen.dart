                ...
                Container(
                  child: Column(
                    children: <Widget>[
                      ...
                      Card(
                        child: ListTile(
                          title: Text('Nexus Pay'),
                          subtitle: Text('Account Name: Mehedi Hasan Shuvo'
                              '\nAccount Number: 2551510025146'
                              '\nAccount type: Savings Account',style: TextStyle(
                              color: Colors.black,
                              fontFamily: 'kalpurus'
                          ),),
                          trailing: IconButton(
                            ...
                            onPressed: (){
                              Toast.show('Copy Sussessfull', context);
                              Clipboard.setData(ClipboardData(text: '2551510025146'));
                            },
                          ),
                        ),
                      ),
