...
//
//     final placeSearchModels = placeSearchModelsFromJson(jsonString);

import 'dart:convert';

PlaceSearchModels placeSearchModelsFromJson(String str) => PlaceSearchModels.fromJson(json.decode(str));

String placeSearchModelsToJson(PlaceSearchModels data) => json.encode(data.toJson());

class PlaceSearchModels {
  PlaceSearchModels({
  ...
  factory PlaceSearchModels.fromJson(Map<String, dynamic> json) => PlaceSearchModels(
...
enum Type { MOSQUE, PLACE_OF_WORSHIP, POINT_OF_INTEREST, ESTABLISHMENT }

final typeValues = EnumValues({
  "establishment": Type.ESTABLISHMENT,
  "mosque": Type.MOSQUE,
  "place_of_worship": Type.PLACE_OF_WORSHIP,
